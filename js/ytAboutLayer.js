var ytAboutLayer = (function () {
	...
	ytAboutLayer.prototype.addAboutTxt = function () {
		...
		var txtList = [
			...
			"Y: To be honest, the game engine is from the Internet. I think I need to say 'thanks' to these authors.",
			"A: And would you mind tell me some technical information about this game?",
			"Y: Yes of Course. This game is based on HTML5 and HTML5 game engine lufylegend.js.",
